...
if(input_enter){
	switch(grid[# 1, menu_option[page]]){
		...
		case menu_type.input: //No breaks in here, so we can apply the inputting toggle to all of these.
		case menu_type.shift: //We dont use default either in case the enum goes out of value.
